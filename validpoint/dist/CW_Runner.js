...
if(result[0].type=="A"&&result[1].type=="CNAME")
{
...
// If there was a failure, we're not moving on to the next step, so sanitize the output and resolve early with a FAIL
{
...
// ...or a rejection from a test error
{
...
if(!yargs.argv.command||yargs.argv.command=="all")
{
returnValue.command=CW_Constants.DEFAULT_COMMANDS;
}else
