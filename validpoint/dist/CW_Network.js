...
class CW_Network {
  ...
  checkWebsiteContent({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkWebsiteContent(resolve, reject, {
        url: url
      }).catch(error => {
        reject(error);
      });
  ...
  checkWebsiteResponse({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkWebsiteResponse(resolve, reject, {
        url: url,
        port: port
      });
    });
  ...
  checkWebsiteAvailability({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkWebsiteAvailability(resolve, reject, {
        domain: domain,
        port: port
      });
    });
  ...
  getWhoisInfo({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_getWhoisInfo(resolve, reject, {
        domain: domain
      });
    });
  }
  ...
  checkDomain({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkDomain(resolve, reject, {
        domain: domain,
  ...
  checkSSL({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkSSL(resolve, reject, {
        url: url
      });
    });
  }
  ...
  checkSSLExpiration({
    ...
    let resolver = new CW_PromiseResolver();
    return new Promise((resolve, reject) => {
      resolver.resolve_checkSSLExpiration(resolve, reject, {
        url: url
      });
    });
  }
