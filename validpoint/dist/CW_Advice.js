...
if(returnValue.result==CW_Constants.IGNORE)// simple population of IGNORE items - something that presumably did not actually run
{
returnValue.severity=CW_Constants.SEVERITY_IGNORE;
}else
// Farm out logic for parsing FAIL and PUNT conditions
{
