...
if(this.test_result.days_til_expiry<90)
{
...
// There was either a failure or a notification
{
...
// lookup the content based on the info we have
{
...
if(severity==CW_Constants.SEVERITY_OK)// "OK" conditions that may have extra output
{
returnValue.printAnswer="good\n".ok;
returnValue.printDetail=returnValue.printDetail.ok;
}else
// Errors (not a notice or "OK" with a tag)
{
...
// handle more complex responses and direct messages
{
this.content="";
tags.forEach(
(tag)=>
...
if(inputObject&&inputObject=="NO_WHOIS")
{
returnValue.push(
{
intermediate_key:inputObject,
...
if(inputObject&&inputObject.message&&inputObject.message.length>1)
{
returnValue.push(
{
