      ...
      if (adviceObject.item_result.category == "website-admin") {
        ...
        if (adviceObject.domainResponses) {
          child = new ChildClass({
            command: adviceObject.item_result.command,
            testResult: adviceObject.domainResponses,
            configObject: configObject
          });
        } else if (adviceObject.item_result) {
          child = new ChildClass({
            command: adviceObject.item_result.command,
            testResult: adviceObject.item_result,
            configObject: configObject
          });
        }
